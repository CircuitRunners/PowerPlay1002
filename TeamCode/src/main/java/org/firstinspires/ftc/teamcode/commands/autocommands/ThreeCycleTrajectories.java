    ...
    public static void generateTrajectories(SampleMecanumDrive drive) {
        ...
        rightPreloadToPole =
                drive.trajectorySequenceBuilder(ThreeCycleTrajectories.rightStartingPosition)
                        ...
                        .splineTo(new Vector2d(36, -30), toRadians(91))
                        .splineTo(rightPreloadPosition.vec(), toRadians(112))
                        .build();
        ...
        leftPreloadToPole =
                drive.trajectorySequenceBuilder(ThreeCycleTrajectories.leftStartingPosition)
                        ...
                        .splineToConstantHeading(new Vector2d(-37, -48.5), toRadians(90))
                        .splineToConstantHeading(new Vector2d(-34, -35), toRadians(89.5))
                        .splineTo(leftPreloadPosition.vec(), toRadians(65))
        ...
        rightToStackPreload =
                drive.trajectorySequenceBuilder(rightPreloadPosition)
                        .setReversed(false)
                        .splineTo(new Vector2d(45, -7.3), toRadians(0)) //to stack
        ...
        leftToStackPreload =
                drive.trajectorySequenceBuilder(leftPreloadPosition)
                        .setReversed(false)
                        .splineTo(new Vector2d(-45, -7.3), toRadians(180)) //to stack
        ...
        rightToPole =
                drive.trajectorySequenceBuilder(rightStackPosition)
                        .setReversed(true)
                        .splineTo(new Vector2d(45, -7.3), toRadians(180))
        ...
        leftToPole =
                drive.trajectorySequenceBuilder(leftStackPosition)
                        .setReversed(true)
                        .splineTo(new Vector2d(-45, -7.3), toRadians(0))
        ...
        leftToStack =
                drive.trajectorySequenceBuilder(leftDropPosition)
                        .setReversed(false)
                        .splineTo(new Vector2d(-45.3, -7.3), toRadians(180)) //to stack
                        .splineTo(leftStackPosition.vec(), toRadians(180))
                        .build();
        ...
        leftLeftPark =
                drive.trajectorySequenceBuilder(leftDropPosition)
                        .setConstraints(getVelocityConstraint(45, toRadians(240), DriveConstants.TRACK_WIDTH), getAccelerationConstraint(45))
                        .setReversed(false)
                        .forward(6)
                        .turn(toRadians(-43))
                        .strafeLeft(23)
